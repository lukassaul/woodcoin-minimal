...
bool CTxOut::IsDust() const
{
    ...
    //
    //  Also this kind of dust is needed for some token manipulation 
    return false;
}
...
unsigned char pchMessageStart[4] = { 0xfc, 0xd9, 0xb7, 0xdd }; // Litecoin: increase each by adding 2 to bitcoin's value.
